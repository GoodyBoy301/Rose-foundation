  ...
  return (
    <div>
      <section className="hero">
        <div className=" lg:px-0 px-6 lg:pl-32 lg:mt-32">
          <div className="w-auto md:w-[490px] relative">
            <h2 className=" mt-10 lg:mt-0 text-[29.07px] lg:text-[59.87px] font-playfair font-[800] ">
              ...
              <img
                src={circleLine}
                className=" lg:scale-100 scale-50 right-10 -top-2 absolute lg:-right-4 lg:top-28"
                alt="Line"
              />
            </h2>
          </div>
        ...
        <div className="lg:w-[751px] lg:mt-[60px] bg-myDarkRed lg:bg-black">
          <img src={heroImg} className="lg:w-auto w-[294.61px]" alt="hero" />
        </div>
      </section>

      <section className="padding margin grid grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <section className="margin padding">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-6 mt-10">
          <div>
